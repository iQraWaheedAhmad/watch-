    ...
    <nav className="bg-black p-4 fixed w-full top-0 left-0 z-10 shadow-lg">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-black p-4 space-y-2">
          ...
          <Link
            href={"/registrationfom"}
            className="block text-white bg-yellow-500 px-4 py-2 rounded hover:bg-yellow-400"
          >
            Register
          </Link>
          <Link
            href={"/button_login"}
            className="block text-white bg-gray-500 px-4 py-2 rounded hover:bg-gray-400"
          >
            Login
          </Link>
        </div>
